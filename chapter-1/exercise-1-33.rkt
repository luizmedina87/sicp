...
(define (filtered-accumulate-rec combiner 
                                 predicate 
                                 null-value 
                                 term 
                                 a 
...
(define (sum-squares-primes a b)
   ; Adapting fast-prime? for use here. 40 is the number of times 
   ; to test the number for primality, which probabilistically 
   ; ensures the number is prime for all relavant purposes.
	(define (prime? n)
		(cond ((< n 2) false)
